...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions([
        'selectUserInfoFdhListByNameOrNumberOrOffice',
      ]),
      // 搜索
      selectSearch(){
        switch (this.radio){
          case 1: //根据姓名搜索
            this.selectUserInfoFdhListByNameOrNumberOrOffice({name:this.search,department:'',number:''});
            break;
          case 2:
            this.selectUserInfoFdhListByNameOrNumberOrOffice({department:this.search,name:'',number:''});
            // 根据科室搜索
            break;
          case 3:
            this.selectUserInfoFdhListByNameOrNumberOrOffice({number:this.search,name:'',department:''});
            // 根据工号搜索
            break;
        }
      }
