...
<template>
    <div name="buttons" class="buttons">
      <el-row>
        <el-col :span="24">
          <el-button type="info" icon="el-icon-document" @click="lookWork" size="small">查看任务</el-button>
          <!--<el-button type="info" icon="el-icon-document" @click="lookIndicator" size="small">查看指标</el-button>-->
          <el-button type="primary" icon="el-icon-plus" @click="addWork" size="small">添加任务</el-button>
