  ...
  <el-dialog :value="value" name="WorkDialog" :visible.sync="isShow" :before-close="handleClose" :title="title" width="750px"
    ...
    <el-form ref="form" :model="form" :rules="rule" label-width="100px" label-position="right">
      <el-form-item label="消息标题" prop="name">
        <el-input v-model="form.title" size="medium" :maxlength="30" auto-complete="new-account" placeholder="请输入消息名称"></el-input>
      </el-form-item>
      <tr>
       <td> <el-form-item label="消息类型" prop="workType">
          <el-select v-model="form.workType" placeholder="请选择消息类型">
    ...
    <tr>
      ...
      <tr>
        <td><el-form-item label="发布时间" prop="beagntime ">
          <el-date-picker
...
<script>
  ...
  import Advices from '../../../services/AdvicesService'
            ...
            this.$refs['form'].validate((valid) => {
              switch (this.type) {
                case 1: // 新增
                  ...
                  Advices.addAdvices(this.form).then((res) => {
                    if (res.code === 200) {
